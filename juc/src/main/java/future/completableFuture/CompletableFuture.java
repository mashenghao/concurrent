 ...
 * @since 1.8
 */
public class CompletableFuture<T> extends java.util.concurrent.CompletableFuture<T> implements Future<T>, CompletionStage<T> {
    ...
    /**
     * 当前Future完成后，回去触发这个方法，用来执行下一个stage。
    ...
    final void postComplete() {
        ...
        while ((h = f.stack) != null ||  //当前Future的stack有下一个处理Completion。 第一次循环走 ||前
               (f != this && (h = (f = this).stack) != null)) { //
            CompletableFuture<?> d; Completion t;
            if (f.casStack(h, t = h.next)) { //将当前Future的stack设置为stack.next
                if (t != null) { //next不为空
                    if (f != this) {
                        pushStack(h);
                        continue;
                ...
                //。。。。 在这里触发了stack顶的Completion执行，内部又会触发顶部Completion的stack执行栈，递归了  。。。。
    ...
    private <V> CompletableFuture<V> uniComposeStage(
        ...
        if (e == null && (r = result) != null) {
            ...
            try {
                @SuppressWarnings("unchecked") T t = (T) r;
                CompletableFuture<V> g = (CompletableFuture<V>) f.apply(t).toCompletableFuture();
                Object s = g.result;
                if (s != null)
    ...
    private <U,V> CompletableFuture<V> biApplyStage(
        ...
        CompletableFuture<U> b;
        if (f == null || (b = (CompletableFuture<U>) o.toCompletableFuture()) == null)
    ...
    private CompletableFuture<Void> biRunStage(Executor e, CompletionStage<?> o,
                                               Runnable f) {
        CompletableFuture<?> b;
        if (f == null || (b = (CompletableFuture<?>) o.toCompletableFuture()) == null)
            throw new NullPointerException();
        CompletableFuture<Void> d = new CompletableFuture<Void>();
