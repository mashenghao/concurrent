...
public class ThreadPoolExecutor1 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ThreadPoolExecutor pool =
                new ThreadPoolExecutor(1, 2, 3, TimeUnit.SECONDS, new ArrayBlockingQueue<Runnable>(3), new ThreadPoolExecutor.AbortPolicy());


        pool.submit(() -> {
            System.out.println(ThreadUtil.getName() + " is doing ...");
